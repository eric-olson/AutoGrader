...
TEST_P(CSCITest, sum) {
	...
	EXPECT_EQ(output, list_to_vector(compress(input)));
}	
...
association<input_t,input_t> testvals[] = {
	...
	{{{"foo","foo","foo"}},{{"foo"}}},
	{{{"foo","foo","foo","bar","baz","baz"}},{{"foo","bar","baz"}}},
	{{{"green","green","green","blue","blue","blue","blue","red","red","red"}},{{"green","blue","red"}}},
	{{{"green","green","blue","red","green"}},{{"green","blue","red","green"}}},
	{{{"green","green","blue","blue","blue","red","green","green","green"}},{{"green","blue","red","green"}}},
	{{{"cat","dog","dog","dog","dog","fish","fish","cat","cat","dog","dog","fish"}},{{"cat","dog","fish","cat","dog","fish"}}}
};
